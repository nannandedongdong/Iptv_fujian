...
public class GetSearchResultTask extends BaseTask<Map<String, String>> {
    public GetSearchResultTask(TaskCallback callback) {
        super(callback);
    }
    ...
    protected TaskResult doInBackground(Map<String, String>... params) {
        ...
        ret.taskId = Constants.TASK_GETSEARCHRESULT;
        try {
