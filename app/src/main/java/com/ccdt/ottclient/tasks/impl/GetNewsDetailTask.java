...
public class GetNewsDetailTask extends BaseTask<String> {

    public GetNewsDetailTask(TaskCallback callback) {
        super(callback);
    }
    ...
    protected TaskResult doInBackground(String... params) {
        ...
        ret.taskId = Constants.TASK_GETNEWSDETAIL;
        try {
            ret.data = OTTServiceApi.getInstance().getNewsDetail(params[0]);
            ret.code = 200;
            ret.message = "success";
        } catch (Exception e) {
