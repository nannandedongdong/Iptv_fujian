 ...
 */
public class UnsubscribeTask extends BaseTask<String> {
    public UnsubscribeTask(TaskCallback callback) {
        super(callback);
    }
    ...
    protected TaskResult doInBackground(String... params) {
        ...
        ret.taskId = Constants.TASK_UNSUBSCRIBE;
        ...
        try {
            String unsubscribe = MyApp.getOTTApi().unsubscribe(productId);
