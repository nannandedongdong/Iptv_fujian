...
public class MovieDetailActivity extends BaseActivity
        ...
        TaskCallback, AdapterView.OnItemClickListener {
...
//        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        ...
        btnSeries.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (seriesBundle != null) {
                    Utility.showSeriesDialog(MovieDetailActivity.this, seriesBundle);
                }
            }
        });
    ...
    private void initGrid() {
        ...
        adapter = new MovieDetailAdapter(this, recommendObjs);
