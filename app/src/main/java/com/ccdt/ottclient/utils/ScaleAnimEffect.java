...
public class ScaleAnimEffect {
	...
	public static Animation alphaAnimation(float paramFloat1, float paramFloat2,
	 ...
	 * @return
	 */
	public static Animation translAnimation(float fromXDelta, float toXDelta,
	 ...
	 * @return
	 */
	public static Animation ScaleAnimation(float fromXScale,float toXScale,float fromYScale,float toYScale){
